...
if wget -q https://github.com/Anuudek/botAnuudek/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[1;35m"
git clone https://github.com/Anuudek/botAnuudek.git
...
echo -e "\033[01;32m\033[01mIniciando botAnuudek!!\nStarting botAnuudek!!\n\033[0m"
npm start
