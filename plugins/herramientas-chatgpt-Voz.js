...
const sistema1 = `Você atuará como um WhatsApp Bot criado por Anuudek. Você será o botAnuudek e deverá escrever tudo em minúsculo, pois é a sua estética`;
...
handler.command = /^(chatgptvoz)$/i;
export default handler;

async function tts(text = 'error', lang = 'pt') {
