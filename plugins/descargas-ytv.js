...
if (!args[0]) return conn.reply(m.chat, `${lenguajeGB['smsAvisoMG']()}coloque o link do vídeo para baixa-lo. por exemplo:\n_${usedPrefix + command} https://www.youtube.com/watch?v=9KWOTBhWhyU_`, m)
...
await conn.reply(m.chat, `${lenguajeGB['smsAvisoEG']()}fazendo o download do vídeo, aguarde...`, m)
try {
let qu = args[1] || '360'
let q = qu + 'p'
let v = youtubeLink
